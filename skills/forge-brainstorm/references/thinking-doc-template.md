...
> 本文件 300+ 行，模板占大头，按当前动作搜小节标题跳读即可。

| 小节 | 何时需要读 |
|---|---|
| 5.1 自审 | 写文档前自己先过一遍检查项时 |
| 5.2 对抗性审查（派 subagent） | 需要派 subagent 挑战方案结论时 |
| 5.3 用户确认 | 审查完成后向用户汇报并等确认时 |
| 5.4 文档模板 | 实际落盘思考文档时：含「需求讨论」多轮模板和「头脑风暴」单次模板两套 |
| 5.5 交互链路稿（跨阶段活文档） | 讨论涉及页面/交互流程、需要产出可跨 PRD/工程阶段续写的链路稿时 |
